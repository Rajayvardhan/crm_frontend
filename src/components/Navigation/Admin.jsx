      ...
      <aside className="d-flex flex-column justify-content-between bg-light  min-vh-100" style={{ width: '260px', borderRight: "1px dashed #ddd9d9" }}>
        <div className=" pt-4" style={{
          ...
          <ul className="nav flex-column sidebar-menu small fw-medium">
            ...
            <li className="nav-item"><NavLink className={({ isActive }) => `nav-link ${isActive ? 'active text-primary fw-bold bg-white rounded shadow-sm' : 'text-secondary'}`} to="/alltask"><i className="fas fa-users"></i> Employees Task</NavLink></li>
